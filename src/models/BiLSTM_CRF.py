...
class BiLSTM_CRF(nn.Module):
    ...
    def __init__(self, tag_to_ix, embedding_dim, hidden_dim):
        ...
        self.transitions.data[tag_to_ix[START_TAG], :] = -100
        self.transitions.data[:, tag_to_ix[STOP_TAG]] = -100
...
#                 print(utils.log_sum_exp(next_tag_var).view(1))
    ...
    def _score_sentence(self, feats, tags):
        ...
        score = torch.zeros(1)
        tags = torch.cat([torch.tensor([self.tag_to_ix[START_TAG]], dtype=torch.long), tags.squeeze()])
